...
namespace OrderService.GraphQL
{
    ...
    {
        [Authorize]
        public IQueryable<Order> GetAllOrders([Service] Latihan4Context context) =>
           context.Orders;
       
        [Authorize]
        public IQueryable<Order> GetOrders([Service] Latihan4Context context, ClaimsPrincipal claimsPrincipal)
        {
